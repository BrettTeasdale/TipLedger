...
public class BarChartMonthlyActivity extends BaseActivity implements OnChartValueSelectedListener {
    /**
    ...
    /**
     * Initialize the BarChartMonthlyActivity activity
     *
     ...
     *
     * @return boolean whether or not the data feetching has been completed
     */
